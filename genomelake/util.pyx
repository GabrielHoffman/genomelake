...
# September 20
# This functional now encoded heterozygotes 
cpdef void one_hot_encode_sequence(str seq, float[:, :] encoded) except *:
    cdef size_t row_idx = 0
    ...
    # based on hsh_converted in one_hot_encode_sequence_ambig function
    hsh = {
    'A': [1., 0., 0., 0.], 
    'C': [0., 1., 0., 0.], 
    'G': [0., 0., 1., 0.], 
...
# Python implementation of nucleotide coding using 
# def convertCoding( a ):
#   b = np.zeros([4,])
#   for entry in a:
#     b[entry[0]] = entry[1]
...
#         encoded[row_idx,] = hsh_converted[base]
#         row_idx = row_idx + 1
...
# # Encode ambiguity codes by creating 4 element arrays for each nucleotide
...
# # Encode ambiguity codes by creating array of (index, value)
# # since encoded is already initialized to zero, 
# # only modify indeces with non-zero values
...
#     # based on hsh in one_hot_encode_sequence_ambig function
#     hsh = {'A': [(0, 1)], 
#     'C': [(1, 1)], 
#     'G': [(2, 1)], 
#     'T': [(3, 1)], 
